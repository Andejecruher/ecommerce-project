    ...
    "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium font-body transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
    {
        variants: {
            variant: {
                ...
                luxury: "bg-primary text-primary-foreground border-2 border-primary hover:bg-transparent hover:text-primary tracking-wider uppercase text-xs font-semibold active:scale-[0.98] rounded-sm",
                "luxury-outline": "bg-transparent text-foreground border border-foreground/30 hover:border-foreground hover:bg-foreground hover:text-background tracking-wider uppercase text-xs font-semibold active:scale-[0.98] rounded-sm",
                "luxury-ghost": "bg-transparent text-foreground hover:text-primary tracking-wide active:scale-[0.98]",
            },
            size: {
