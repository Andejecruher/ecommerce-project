            ...
            <div className="p-6 sm:px-25 sm:py-22 gap-[30px] flex flex-col max-w-auto lg:flex-row lg:justify-between lg:items-center ">
                <div className=" sm:flex sm:justify-between sm:items-center">
                    <div className="flex-col  ">
                        ...
                        <p className="mt-7 sm:mt-9 max-w-[400px] text-[#AFADB5] sm:text-title-950 font-['Eudoxus_Sans'] font-medium text-[14px] sm:text-[18px] leading-[180%] ">
                ...
                <div className="grid grid-cols-3  sm:gap-20 md:justify-start ">
                    <ul className="inline-flex flex-col items-start gap-2 sm:gap-3">
                        <li className="text-title-950 font-['Eudoxus_Sans'] sm:mb-4 text-[16px] sm:text-[20px] font-bold leading-[130%]">
                            Product
                        </li>
                        <li className="text-[#AFADB5] sm:text-title-950 font-['Eudoxus_Sans'] text-[14px] sm:text-[18px] font-medium leading-[180%]">
                            New Arrivals
                        </li>
                        <li className="text-[#AFADB5] sm:text-title-950 font-['Eudoxus_Sans'] text[14px] sm:text-[18px] font-medium leading-[180%]">
                            Best Selling
