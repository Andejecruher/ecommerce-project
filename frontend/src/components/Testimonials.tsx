  ...
  return (
    <section>
      <div className="px-6 xl:px-[392px] flex flex-col items-center mt-25 lg:mt-[180px]">
        ...
        <h1 className="text-title-950 font-['Eudoxus_Sans'] text-[24px] sm:text-[30px] lg:text-[44px] mt-2 sm:mt-3 font-bold leading-[130%]">
          What our customer say
        </h1>
        <p className="text-[#AFADB5] w-[327px] lg:w-[656px]  mt-[18px] md:mt-[30px]   font-['Eudoxus_Sans'] font-medium text-[14px] sm:text-[18px]  leading-[180%]">
        ...
        <div>
          {TestimonialsCards.map((card) => {
            return (
              <div className="flex sm:mt-5 shadow-[0_4px_100px_0_rgba(175,173,181,0.10)]  px-4 flex-col  bg-white h-[205px]  ">
                ...
                <div className="mb-[18px] mt-[18px] flex justify-between ">
                  <div className="flex items-center gap-3.5">
                    ...
                    />
                    <h1 className=" text-title-950 font-['Eudoxus_Sans'] font-bold text-[14px] md:text-[20px] leading-[130%]">
                      {card.title}
                    </h1>
                  </div>
